...
export default function HeroEmailForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 w-full max-w-md">
      ...
      <button
        type="submit"
        className="shrink-0 bg-promote-gold hover:brightness-110 text-navy-dark font-bold px-6 py-3.5 rounded-xl text-sm transition-all whitespace-nowrap shadow-lg shadow-promote-gold/30"
      >
        Start Building Free →
      </button>
    </form>
