...
// Same dual real-session/SSO-cookie check used by /admin/ops and
// /admin/seo — lets the cross-app SSO ticket mechanism authenticate
// API routes, not just page loads.
