// Phase 3: Insights. Every generated app defines a `vw_metrics_daily` view
// in its own tenant schema — shape (day date, metric_key text, value
// numeric). The nightly cron snapshots each app's view into the
// platform-side app_metrics table; the dashboard reads from there.
